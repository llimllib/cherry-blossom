...
Autogenerated by CHEETAH: The Python-Powered Template Engine
 CHEETAH VERSION: 1.0
 Generation time: Mon Nov  6 10:07:06 2006
   Source file: head.tmpl
   Source file last modified: Mon Nov  6 10:05:58 2006
"""

__CHEETAH_genTime__ = 'Mon Nov  6 10:07:06 2006'
...
<title>''')
        ...
        if __v is not None: write(filter(__v, rawExpr="$getVar('blog_title', '')")) # from line 5, col 8.
        write(' \r\n')
        if VFFSL(SL,"varExists",False)('title'):
            write('    - ')
            __v = VFFSL(SL,"getVar",False)('title', '')
            if __v is not None: write(filter(__v, rawExpr="$getVar('title', '')")) # from line 7, col 7.
            write('\r\n')
        write('''</title>
...
''')
        if VFFSL(SL,"varExists",False)('keywordrss'):
            ...
            if __v is not None: write(filter(__v, rawExpr='$keywordrss')) # from line 21, col 12.
